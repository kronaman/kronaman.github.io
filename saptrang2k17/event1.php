  ...
  <div class=" container-fluid page-home">
    <div class="col-md-2 sidebar">
      ...
      <div class="col-md-12 sidebar-content" >
        <h2 class="text-center" style="font-weight:700;font-size:38px; color: #9616ff;">Events</h2>
      </div>
    </div>
            ...
            <div id="column_line_up_areas" class="column_line_up_areas column_line_up_show" >
              <section class="column_line_up_area" style="width:500px;padding:4%;">
                <div class="top">
                  <div class="row">
                    <div>
                      <h1 style="color: #9616ff;">Genres</h1>
                    </div>
                  </div>
                </div>
                <div class="content1 " style="padding-left: 4%;">
                  <ul>
<li><div style="background-image: url('images/da.jpeg');"><h3 onclick="showDivd()">DANCE</h3></div></li>
<li><h3 onclick="showDivm()">MUSIC</h3></li>
<li><h3 onclick="showDivdr()">DRAMATICS</h3></li>
<li><h3 onclick="showDiva()">FINE ARTS</h3></li>
<li><h3 onclick="showDivp()">PHOTOGRAPHY</h3></li>
<li><h3 onclick="showDivf()">FASHION</h3></li>
<li><h3 onclick="showDivi()">INFORMAL</h3></li>
</ul>
                  <br>
                </div>
              </section>
...
<!-- ** 2nd box Saptrang ** -->
          <div id="column_line_up_2" class="col-sm-3 col-xs-12">
            ...
            <h2 onclick="showDivm3()">Aaroh</h2>
            <h2 onclick="showDivm4()">Razzmatazz</h2>
			
			</div>
            <div id="welcomeDivdr" style="display:none;" class="answer_list">
			
			<h2 onclick="showDivdr1()">Goonj</h2>
            <h2 onclick="showDivdr2()">Mono Act</h2>
         
   		
			</div>
            <div id="welcomeDiva" style="display:none;" class="answer_list">
			
			<h2 onclick="showDiva1()">Mural painting</h2>
            <h2 onclick="showDiva2()">Strokes</h2>
			
			</div>
            <div id="welcomeDivp" style="display:none;" class="answer_list">
			
			<h2 onclick="showDivp1()">Parallax</h2>
			<h2 onclick="showDivp2()">Short Film Making</h2>
			
			</div>
	     <div id="welcomeDivf" style="display:none;" class="answer_list">
			
			<h2 onclick="showDivf1()">Run Way</h2>
			</div>
		 <div id="welcomeDivi" style="display:none;" class="answer_list">
			
			<h2 onclick="showDivi1()">Informal</h2>
			</div>
            ...
            <div id="column_line_up_areas" class="column_line_up_areas column_line_up_show">
              <section class="column_line_up_area" style="width:900px;padding:4%;">
                <div class="top">
                  <div class="row">
                    <div class="col-md-6">
                      <h1 style="color:#9616ff">Details</h1>
                    </div>
...
<li>Marks shall be deducted for exceeding the time limit.</li>
          ...
          <br>Shubhangi(7289087119)
					  <form action="eventReg.php" method="post">
						<input type="submit" name="eventReg" value="register"/>
...
3. This is a group event but not intercollege i.e. there can be more than one team representing the college.<br><br>
...
2. The max time limit is 3 min (Empty stage to empty stage).<br>
...
3. Pre-recorded music/Karaoke is allowed.<br> 
4. The song chosen can be of any genre. Bollywood songs are allowed. Original compositions are also allowed.<br>
5. Participants have to bring their own accompanying instruments or backing tracks as the case may be.<br>
...
2. Minimum 8 and maximum 15 members in each team are allowed. Music accompanists are included in this.<br>
3. Teams should restrict their play in 20 mins (empty stage to empty stage). Negative marks will be awarded for exceeding time limit. <br>
4. Teams can use English, Hindi or both, however short passages in other languages are allowed. <br>
5. Teams will be judged on the basis of creativity, props, clarity of message, costume, dressing, team work.  <br>
6. The Competition will be conducted on a “Street” like open place with audience all around and hence no microphones, speakers, music systems or any other electrical appliance will be allowed or available. Teams can sing / dance by themselves to create the necessary music or sound. <br>
7. Only live music is allowed. Teams will have to bring their own instruments - no instrument shall be provided.<br> 
8. Teams using any props / costume / dressing must bring all their requirements and must be ready well in time as per instructions of the organizer. No Props or costume or any material will be provided by the host college. <br>
9. Teams must rehearse / practice the play well in advance. No Time for rehearsal / Stage practice / final rehearsal will be given during the fest. <br>
10. Any kind of fluid, live animals, flame, heavy object or any material which has a possibility of damaging the stage is not allowed. </ol>
				  
				  <br><br>
				  <b>Event Co-ordinators</b>
				  <br>Pradip(9426495019)
				  <br>Prathu(9571936774)
				  <br>Ashwini(8571832990)	
					<form action="eventReg.php" method="post">
						<input type="submit" name="eventReg" value="register"/>
...
6. All the entries submitted will be uploaded to the Saptrang’s Facebook Page (https://www.facebook.com/SaptrangNitd) and tag yourself.<br>
...
<br>
				  <b>How to submit your entiries?</b><br>
				  <ol> 
...
2. There is no limit to the number of Entries an Entrant may submit, but each Entry must follow the technical, creative, and legal entry requirements.<br>
...
2.	Time limit for the performance is 10 minutes (including setup and performance both).<br>
3.	It is an open theme event where participants can choose their own theme.<br>
4.	Participants should carry their tracks in a pendrive.<br>
5.	Vulgarity is strictly prohibited. Any form of obscenity will lead to debarring the team from the contest.<br>
6.	Teams will be judged on costumes, walking stance, makeup, relevance to theme and attitude.<br>
7.	Team members should make their own arrangements for makeup, costumes, etc.<br>
8.	Decision of judges will be final and binding. 
 </ol>
