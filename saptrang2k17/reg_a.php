...
function changeTexty(){
     document.getElementById("submit").value = "Proceed to Pay Rs. 500/-";
}
        ...
        <div class="col-md-2 sidebar">
            ...
            <div class="col-md-12 sidebar-content">
                <ul class="list-unstyled">
                        ...
                        <a class="menu-active" href="#" style=" color: #42C0FB;" >Registrations</a>
                        </li>                   
                    <li class="sidebar-menu">
                    ...
                    <div id="column_line_up_1" class="col-sm-2 col-sm-offset-1 col-xs-12">
                        <section class="column_line_up_area" style="width:500px;padding:4%;">
                            <div class="row col-xs-12">
                                ...
                                <br>
                                <p class="text-inverse text-center">Register here to be a part of Saptrang 2k17</p>
                            </div>
...
<?php if(isset($_SESSION['email_exist'])) {echo ' Email Already Registered'; session_destroy();} ?></p></span>
									...
									Accomodation Required ?
                                                            Yes : <input type="radio" name="acm" value="yes" onclick="changeTexty()"/>
                                                             No : <input type="radio" name="acm" value="no" onclick="changeTextn()" checked="checked"/><br>

                                                        (You Need To Pay Rs. 500/- for accomodation )
